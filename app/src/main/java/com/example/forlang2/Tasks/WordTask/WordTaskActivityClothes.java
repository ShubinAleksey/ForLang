...
public class WordTaskActivityClothes extends AppCompatActivity {
    ...
    Context context = WordTaskActivityClothes.this;
            ...
            public void onClick(View view) {
                ...
                if (checkButton.getText().equals("проверить")) {
                    ...
                    if (answer.toString().equals(questionModel.getAnswer() + " ")) {
                        ...
                        Toast.makeText(WordTaskActivityClothes.this, "Совершенно верно!", Toast.LENGTH_SHORT).show();
                        ...
                        Toast.makeText(WordTaskActivityClothes.this, "Неправильный ответ. \n" + questionModel.getAnswer(), Toast.LENGTH_SHORT).show();
                    ...
                    if (progressBarValue < 100) {
                        ...
                        activityNavigation.takeToRandomTaskClothes();
    ...
    private void randomizeCustomWords() {
        ...
        for (String word : words) {
            ...
            customWord.setOnTouchListener(new WordTaskActivityClothes.TouchListener());
        ...
        new MaterialDialog.Builder(this)
                ...
                .onPositive(new MaterialDialog.SingleButtonCallback() {
                    ...
                    public void onClick(@NonNull MaterialDialog dialog, @NonNull DialogAction which) {
                        progressBarValue = 0;
                        Hawk.put("progressBarValue", progressBarValue);
                        Intent intent = new Intent(WordTaskActivityClothes.this, ChooseLessonClothes.class);
