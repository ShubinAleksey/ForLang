...
public class TapPairActivityAnimals extends AppCompatActivity {
    ...
    Context context = TapPairActivityAnimals.this;
    ...
    private void initData() {
        ...
        pairs = repository.getPairsAnimals();
    ...
    private void randomizePair() {
        ...
        for (int i = 0; i < randomN; i++) {
            ...
            customWord1.setOnTouchListener(new TapPairActivityAnimals.TouchListener());
            customWord2.setOnTouchListener(new TapPairActivityAnimals.TouchListener());
                ...
                if (!isSearchingPair()) {
                    ...
                    if (previousWord != view) {
                        ...
                        if (previousWord.getTag() == view.getTag()) {
                            ...
                            Toast.makeText(TapPairActivityAnimals.this, "Правильная схожесть", Toast.LENGTH_SHORT).show();
                            ...
                            Toast.makeText(TapPairActivityAnimals.this, "Неправильная схожесть", Toast.LENGTH_SHORT).show();
        ...
        checkButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (progressBarValue < 100) {
                    ...
                    ActivityNavigation.getInstance(context).takeToRandomTaskAnimals();
    ...
    private void checkCompleteness() {
        ...
        if (pairsFormed == randomN) {
            ...
            Toast.makeText(TapPairActivityAnimals.this, "Поздравляю, вы нашли все схожести!", Toast.LENGTH_SHORT).show();
        ...
        new MaterialDialog.Builder(this)
                ...
                .onPositive(new MaterialDialog.SingleButtonCallback() {
                    ...
                    public void onClick(@NonNull MaterialDialog dialog, @NonNull DialogAction which) {
                        progressBarValue = 0;
                        Hawk.put("progressBarValue", progressBarValue);
                        Intent intent = new Intent(TapPairActivityAnimals.this, ChooseLessonAnimals.class);
