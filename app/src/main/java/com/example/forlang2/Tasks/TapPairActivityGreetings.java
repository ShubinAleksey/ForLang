...
public class TapPairActivityGreetings extends AppCompatActivity {
    ...
    Context context = TapPairActivityGreetings.this;
    ...
    private void initData() {
        ...
        pairs = repository.getPairsGreetings();
    ...
    private void randomizePair() {
        ...
        for (int i = 0; i < randomN; i++) {
            ...
            customWord1.setOnTouchListener(new TapPairActivityGreetings.TouchListener());
            customWord2.setOnTouchListener(new TapPairActivityGreetings.TouchListener());
                ...
                if (!isSearchingPair()) {
                    ...
                    if (previousWord != view) {
                        ...
                        if (previousWord.getTag() == view.getTag()) {
                            ...
                            Toast.makeText(TapPairActivityGreetings.this, "Правильная схожесть", Toast.LENGTH_SHORT).show();
                            ...
                            Toast.makeText(TapPairActivityGreetings.this, "Неправильная схожесть", Toast.LENGTH_SHORT).show();
        ...
        checkButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (progressBarValue < 100) {
                    ...
                    ActivityNavigation.getInstance(context).takeToRandomTaskGreetings();
    ...
    private void checkCompleteness() {
        ...
        if (pairsFormed == randomN) {
            ...
            Toast.makeText(TapPairActivityGreetings.this, "Поздравляю, вы нашли все схожести!", Toast.LENGTH_SHORT).show();
        ...
        new MaterialDialog.Builder(this)
                ...
                .onPositive(new MaterialDialog.SingleButtonCallback() {
                    ...
                    public void onClick(@NonNull MaterialDialog dialog, @NonNull DialogAction which) {
                        progressBarValue = 0;
                        Hawk.put("progressBarValue", progressBarValue);
                        Intent intent = new Intent(TapPairActivityGreetings.this, ChooseLessonGreetings.class);
