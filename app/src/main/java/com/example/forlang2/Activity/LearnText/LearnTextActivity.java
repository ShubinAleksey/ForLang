...
public class LearnTextActivity extends AppCompatActivity {
    ...
    Context context = LearnTextActivity.this;
    ...
    private void initData() {
        ...
        textModel = repository.getRandomTextObj();
        progressBarValue = 0;
        ...
        edit.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View view) {
                ...
                handler.postDelayed(() -> {
                    ...
                    Toast.makeText(LearnTextActivity.this, "Слово добавлено: " + copy, Toast.LENGTH_SHORT).show();
        ...
        new MaterialDialog.Builder(this)
                ...
                .onPositive(new MaterialDialog.SingleButtonCallback() {
                    ...
                    public void onClick(@NonNull MaterialDialog dialog, @NonNull DialogAction which) {
                        progressBarValue = 0;
                        Hawk.put("progressBarValue", progressBarValue);
                        Intent intent = new Intent(LearnTextActivity.this, ChooseLesson.class);
