...
public class LearnTextActivityFraze extends AppCompatActivity {
    ...
    Context context = LearnTextActivityFraze.this;
    ...
    private void initData() {
        ...
        textModel = repository.getRandomTextObjFraze();
        progressBarValue = 0;
        ...
        edit.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View view) {
                ...
                handler.postDelayed(() -> {
                    ...
                    Toast.makeText(LearnTextActivityFraze.this, "Слово добавлено: " + copy, Toast.LENGTH_SHORT).show();
        ...
        new MaterialDialog.Builder(this)
                ...
                .onPositive(new MaterialDialog.SingleButtonCallback() {
                    ...
                    public void onClick(@NonNull MaterialDialog dialog, @NonNull DialogAction which) {
                        progressBarValue = 0;
                        Hawk.put("progressBarValue", progressBarValue);
                        Intent intent = new Intent(LearnTextActivityFraze.this, ChooseLessonFraze.class);
