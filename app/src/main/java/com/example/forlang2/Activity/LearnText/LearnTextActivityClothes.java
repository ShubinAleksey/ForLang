...
public class LearnTextActivityClothes extends AppCompatActivity {
    ...
    Context context = LearnTextActivityClothes.this;
    ...
    private void initData() {
        ...
        textModel = repository.getRandomTextObjClothes();
        progressBarValue = 0;
        ...
        edit.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View view) {
                ...
                handler.postDelayed(() -> {
                    ...
                    Toast.makeText(LearnTextActivityClothes.this, "Слово добавлено: " + copy, Toast.LENGTH_SHORT).show();
        ...
        new MaterialDialog.Builder(this)
                ...
                .onPositive(new MaterialDialog.SingleButtonCallback() {
                    ...
                    public void onClick(@NonNull MaterialDialog dialog, @NonNull DialogAction which) {
                        progressBarValue = 0;
                        Hawk.put("progressBarValue", progressBarValue);
                        Intent intent = new Intent(LearnTextActivityClothes.this, ChooseLessonClothes.class);
