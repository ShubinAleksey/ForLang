...
public class WordTaskActivityGreetings extends AppCompatActivity {
    ...
    Context context = WordTaskActivityGreetings.this;
    ...
    private void initData() {
        ...
        questionModel = repository.getRandomQuestionObjGreetings();
            ...
            public void onClick(View view) {
                ...
                if (checkButton.getText().equals("проверить")) {
                    ...
                    if (answer.toString().equals(questionModel.getAnswer() + " ")) {
                        ...
                        Toast.makeText(WordTaskActivityGreetings.this, "Совершенно верно!", Toast.LENGTH_SHORT).show();
                        ...
                        Toast.makeText(WordTaskActivityGreetings.this, "Неправильный ответ. \n" + questionModel.getAnswer(), Toast.LENGTH_SHORT).show();
                    ...
                    if (progressBarValue < 100) {
                        ...
                        activityNavigation.takeToRandomTaskGreetings();
    ...
    private void randomizeCustomWords() {
        ...
        for (String word : words) {
            ...
            customWord.setOnTouchListener(new WordTaskActivityGreetings.TouchListener());
        ...
        new MaterialDialog.Builder(this)
                ...
                .onPositive(new MaterialDialog.SingleButtonCallback() {
                    ...
                    public void onClick(@NonNull MaterialDialog dialog, @NonNull DialogAction which) {
                        progressBarValue = 0;
                        Hawk.put("progressBarValue", progressBarValue);
                        Intent intent = new Intent(WordTaskActivityGreetings.this, ChooseLessonGreetings.class);
