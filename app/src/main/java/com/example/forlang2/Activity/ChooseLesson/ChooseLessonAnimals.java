...
public class ChooseLessonAnimals extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        txtView.setText("Животные");
        if (txtView.getText().equals("Животные")) {
            buttonTS.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Intent trSen = new Intent(ChooseLessonAnimals.this, TSTaskActivityAnimals.class);
                    startActivity(trSen);
                    finish();
                }
            });
            buttonWT.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Intent wrdTas = new Intent(ChooseLessonAnimals.this, WordTaskActivityAnimals.class);
            ...
            buttonTP.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Intent tpPair = new Intent(ChooseLessonAnimals.this, TapPairActivityAnimals.class);
            ...
            buttonText.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Intent tpPair = new Intent(ChooseLessonAnimals.this, LearnTextActivityAnimals.class);
                    startActivity(tpPair);
                    finish();
                }
            });
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent btnBack = new Intent(ChooseLessonAnimals.this, LessonListActivity.class);
