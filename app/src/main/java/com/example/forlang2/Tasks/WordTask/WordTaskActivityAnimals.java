...
public class WordTaskActivityAnimals extends AppCompatActivity {
    ...
    Context context = WordTaskActivityAnimals.this;
    ...
    private void initData() {
        ...
        questionModel = repository.getRandomQuestionObjAnimals();
            ...
            public void onClick(View view) {
                ...
                if (checkButton.getText().equals("проверить")) {
                    ...
                    if (answer.toString().equals(questionModel.getAnswer() + " ")) {
                        ...
                        Toast.makeText(WordTaskActivityAnimals.this, "Совершенно верно!", Toast.LENGTH_SHORT).show();
                        ...
                        Toast.makeText(WordTaskActivityAnimals.this, "Неправильный ответ. \n" + questionModel.getAnswer(), Toast.LENGTH_SHORT).show();
                    ...
                    if (progressBarValue < 100) {
                        ...
                        activityNavigation.takeToRandomTaskAnimals();
    ...
    private void randomizeCustomWords() {
        ...
        for (String word : words) {
            ...
            customWord.setOnTouchListener(new WordTaskActivityAnimals.TouchListener());
        ...
        new MaterialDialog.Builder(this)
                ...
                .onPositive(new MaterialDialog.SingleButtonCallback() {
                    ...
                    public void onClick(@NonNull MaterialDialog dialog, @NonNull DialogAction which) {
                        progressBarValue = 0;
                        Hawk.put("progressBarValue", progressBarValue);
                        Intent intent = new Intent(WordTaskActivityAnimals.this, ChooseLessonAnimals.class);
