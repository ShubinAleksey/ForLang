...
public class WordTaskActivityFraze extends AppCompatActivity {
    ...
    Context context = WordTaskActivityFraze.this;
    ...
    private void initData() {
        ...
        questionModel = repository.getRandomQuestionObjFraze();
            ...
            public void onClick(View view) {
                ...
                if (checkButton.getText().equals("проверить")) {
                    ...
                    if (answer.toString().equals(questionModel.getAnswer() + " ")) {
                        ...
                        Toast.makeText(WordTaskActivityFraze.this, "Совершенно верно!", Toast.LENGTH_SHORT).show();
                        ...
                        Toast.makeText(WordTaskActivityFraze.this, "Неправильный ответ. \n" + questionModel.getAnswer(), Toast.LENGTH_SHORT).show();
                    ...
                    if (progressBarValue < 100) {
                        ...
                        activityNavigation.takeToRandomTaskFraze();
    ...
    private void randomizeCustomWords() {
        ...
        for (String word : words) {
            ...
            customWord.setOnTouchListener(new WordTaskActivityFraze.TouchListener());
        ...
        new MaterialDialog.Builder(this)
                ...
                .onPositive(new MaterialDialog.SingleButtonCallback() {
                    ...
                    public void onClick(@NonNull MaterialDialog dialog, @NonNull DialogAction which) {
                        progressBarValue = 0;
                        Hawk.put("progressBarValue", progressBarValue);
                        Intent intent = new Intent(WordTaskActivityFraze.this, ChooseLessonFraze.class);
