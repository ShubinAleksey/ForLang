...
public class TapPairActivityFood extends AppCompatActivity {
    ...
    Context context = TapPairActivityFood.this;
    ...
    private void randomizePair() {
        ...
        for (int i = 0; i < randomN; i++) {
            ...
            customWord1.setOnTouchListener(new TapPairActivityFood.TouchListener());
            customWord2.setOnTouchListener(new TapPairActivityFood.TouchListener());
                ...
                if (!isSearchingPair()) {
                    ...
                    if (previousWord != view) {
                        ...
                        if (previousWord.getTag() == view.getTag()) {
                            ...
                            Toast.makeText(TapPairActivityFood.this, "Правильная схожесть", Toast.LENGTH_SHORT).show();
                            ...
                            Toast.makeText(TapPairActivityFood.this, "Неправильная схожесть", Toast.LENGTH_SHORT).show();
        ...
        checkButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (progressBarValue < 100) {
                    ...
                    ActivityNavigation.getInstance(context).takeToRandomTaskFood();
    ...
    private void checkCompleteness() {
        ...
        if (pairsFormed == randomN) {
            ...
            Toast.makeText(TapPairActivityFood.this, "Поздравляю, вы нашли все схожести!", Toast.LENGTH_SHORT).show();
        ...
        new MaterialDialog.Builder(this)
                ...
                .onPositive(new MaterialDialog.SingleButtonCallback() {
                    ...
                    public void onClick(@NonNull MaterialDialog dialog, @NonNull DialogAction which) {
                        progressBarValue = 0;
                        Hawk.put("progressBarValue", progressBarValue);
                        Intent intent = new Intent(TapPairActivityFood.this, ChooseLessonFood.class);
