            ...
            public void onClick(View view) {
                ...
                if (checkButton.getText().equals("проверить")) {
                    ...
                    if (answer.toString().equals(questionModel.getAnswer() + " ")) {
                        ...
                        Toast.makeText(WordTaskActivity.this, "Совершенно верно!", Toast.LENGTH_SHORT).show();
                        ...
                        Toast.makeText(WordTaskActivity.this, "Неправильный ответ. \n" + questionModel.getAnswer(), Toast.LENGTH_SHORT).show();
        ...
        new MaterialDialog.Builder(this)
                ...
                .onPositive(new MaterialDialog.SingleButtonCallback() {
                    ...
                    public void onClick(@NonNull MaterialDialog dialog, @NonNull DialogAction which) {
                        progressBarValue = 0;
                        Hawk.put("progressBarValue", progressBarValue);
                        Intent intent = new Intent(WordTaskActivity.this, ChooseLesson.class);
