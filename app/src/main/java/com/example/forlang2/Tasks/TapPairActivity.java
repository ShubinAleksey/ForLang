...
public class TapPairActivity extends AppCompatActivity {
                ...
                if (!isSearchingPair()) {
                    ...
                    if (previousWord != view) {
                        if (previousWord.getTag() == view.getTag()) {
                            Toast.makeText(TapPairActivity.this, "Правильная схожесть", Toast.LENGTH_SHORT).show();
                            ...
                            Toast.makeText(TapPairActivity.this, "Неправильная схожесть", Toast.LENGTH_SHORT).show();
                            previousWord.setBackground(getDrawable(R.drawable.custom_word_border));
                            view.setBackground(getDrawable(R.drawable.custom_word_border));
                            setSearchingPair(false);
                            compareWords.clear();
    ...
    private void checkCompleteness() {
        ...
        if (pairsFormed == randomN) {
            Toast.makeText(TapPairActivity.this, "Поздравляю, вы нашли все схожести!", Toast.LENGTH_SHORT).show();
            progressBarValue += 20;
            progressBar.setProgress(progressBarValue);
            Hawk.put("progressBarValue", progressBarValue);
        ...
        new MaterialDialog.Builder(this)
                ...
                .onPositive(new MaterialDialog.SingleButtonCallback() {
                    ...
                    public void onClick(@NonNull MaterialDialog dialog, @NonNull DialogAction which) {
                        progressBarValue = 0;
                        Hawk.put("progressBarValue", progressBarValue);
                        Intent intent = new Intent(TapPairActivity.this, ChooseLesson.class);
