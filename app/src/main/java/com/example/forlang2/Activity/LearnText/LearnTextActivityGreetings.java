...
public class LearnTextActivityGreetings extends AppCompatActivity {
    ...
    Context context = LearnTextActivityGreetings.this;
    ...
    private void initData() {
        ...
        textModel = repository.getRandomTextObjGreetings();
        progressBarValue = 0;
        ...
        edit.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View view) {
                ...
                handler.postDelayed(() -> {
                    ...
                    Toast.makeText(LearnTextActivityGreetings.this, "Слово добавлено: " + copy, Toast.LENGTH_SHORT).show();
        ...
        new MaterialDialog.Builder(this)
                ...
                .onPositive(new MaterialDialog.SingleButtonCallback() {
                    ...
                    public void onClick(@NonNull MaterialDialog dialog, @NonNull DialogAction which) {
                        progressBarValue = 0;
                        Hawk.put("progressBarValue", progressBarValue);
                        Intent intent = new Intent(LearnTextActivityGreetings.this, ChooseLessonGreetings.class);
