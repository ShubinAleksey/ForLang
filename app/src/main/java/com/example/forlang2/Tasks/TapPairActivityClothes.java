...
public class TapPairActivityClothes extends AppCompatActivity {
    ...
    Context context = TapPairActivityClothes.this;
    ...
    private void initData() {
        ...
        pairs = repository.getPairsClothes();
    ...
    private void randomizePair() {
        ...
        for (int i = 0; i < randomN; i++) {
            ...
            customWord1.setOnTouchListener(new TapPairActivityClothes.TouchListener());
            customWord2.setOnTouchListener(new TapPairActivityClothes.TouchListener());
                ...
                if (!isSearchingPair()) {
                    ...
                    if (previousWord != view) {
                        ...
                        if (previousWord.getTag() == view.getTag()) {
                            ...
                            Toast.makeText(TapPairActivityClothes.this, "Правильная схожесть", Toast.LENGTH_SHORT).show();
                            ...
                            Toast.makeText(TapPairActivityClothes.this, "Неправильная схожесть", Toast.LENGTH_SHORT).show();
    ...
    private void checkCompleteness() {
        ...
        if (pairsFormed == randomN) {
            ...
            Toast.makeText(TapPairActivityClothes.this, "Поздравляю, вы нашли все схожести!", Toast.LENGTH_SHORT).show();
        ...
        new MaterialDialog.Builder(this)
                ...
                .onPositive(new MaterialDialog.SingleButtonCallback() {
                    ...
                    public void onClick(@NonNull MaterialDialog dialog, @NonNull DialogAction which) {
                        progressBarValue = 0;
                        Hawk.put("progressBarValue", progressBarValue);
                        Intent intent = new Intent(TapPairActivityClothes.this, ChooseLessonClothes.class);
